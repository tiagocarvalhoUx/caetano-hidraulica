    ...
    <footer className="w-full">
      <div className="w-full flex flex-col justify-start items-start">
        <div className="w-full py-6 md:py-10 bg-[#0e3e61] flex flex-col justify-start items-center">
          <div className="w-full max-w-[1170px] px-4 md:px-0 flex flex-col justify-start items-center lg:items-start">
            <div className="w-full flex flex-col lg:flex-row justify-start items-center lg:items-start gap-8 lg:gap-0">
              {/* Left Column - Navigation and Description */}
              <div className="w-full max-w-[520px] lg:max-w-none lg:w-[780px] lg:px-[15px] flex flex-col justify-start items-center lg:items-start gap-4 lg:gap-2.5">
                {/* Navigation Links */}
                <div className="w-full flex flex-wrap justify-center lg:justify-start items-center lg:items-start gap-x-3 gap-y-2 lg:gap-[12.70px] text-center lg:text-left">
                ...
                {/* CTA Button */}
                <div className="w-full pb-5 flex flex-col justify-start items-center lg:items-start">
              ...
              <div className="w-full max-w-[520px] lg:max-w-none lg:w-[390px] lg:pl-4 lg:pr-[15px] lg:border-l border-[#ffde00] flex flex-col justify-start items-center lg:items-start gap-4 lg:gap-[5px]">
                <div className="text-center lg:text-left text-white text-sm font-light font-['Lato'] leading-tight">Curta nossa página</div>
                
                <div className="w-full flex flex-col justify-start items-center lg:items-start gap-4 lg:gap-2.5">
                  {/* Instagram Section */}
                  <div className="w-full pt-[5px] pb-1 flex flex-col justify-start items-center lg:items-start gap-3 lg:gap-1.5">
                    <a href="https://www.instagram.com/caetanocacavazamento/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center lg:justify-start gap-3 hover:opacity-80 transition-opacity">
                      <div >
                    ...
                    {/* YouTube Section */}
                    <div className="text-center lg:text-left text-white text-sm font-light font-['Lato'] leading-tight">Conheça nosso canal</div>
                    <a href="https://www.youtube.com/@caetanohidraulica" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center lg:justify-start gap-3 hover:opacity-80 transition-opacity">
                      <div >
                    ...
                    {/* Location Section */}
                    <div className="w-full flex flex-col items-center lg:items-start gap-2 mt-2">
                      <div className="text-center lg:text-left text-white text-sm font-light font-['Inter'] leading-tight">Onde estamos</div>
            ...
            {/* Services Links */}
            <div className="w-full px-4 lg:px-[15px] pt-6 lg:pt-[3px] pb-2 lg:pb-0.5 flex flex-col justify-start items-center lg:items-start">
              <div className="w-full max-w-[520px] lg:max-w-none flex flex-wrap justify-center lg:justify-start gap-x-3 gap-y-2 lg:gap-4 text-center lg:text-left">
        ...
        <div className="w-full pt-6 lg:pt-[25px] pb-5 bg-[#13486d] border-t-[5px] border-[#00bbff] flex flex-col justify-start items-center">
          <div className="w-full max-w-[1170px] px-4 lg:px-0 flex flex-col justify-start items-center lg:items-start">
            <div className="w-full flex flex-col lg:flex-row justify-between items-center lg:items-center gap-5 lg:gap-0">
              ...
              <div className="w-full lg:w-auto flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4">
  <img 
    src={Seguro}  
